...
cor(df[ , -1]) #1st varriable is the class containing food or feed.
```
...
```{r}
#probability of production to be greater or less than 0.8

glm.pred <- rep("Feed", 17938) # make vector
glm.pred[glm.prob > .8] <- "Food" # add Up values
...
## 04 Conclusion
We can conclude fro our analysis that more food were produced in 
the united kingdom in the period in view(2003- 2013). which means that 
more food were cultivated for human consumption than for animal feed.             
